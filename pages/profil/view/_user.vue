<template>
      ...
      <div class="profil__header" v-if="user && avatarUrl">
        <div class="profil__header--thumbnail">
          <el-image
            ...
            style="width: 100%"
          ></el-image>
          <el-image v-else :src="thumbnail.url"></el-image>
          <vui-single-upload
            class="button_upload"
        ...
        <b-container>
          <section class="profil__header--user">
            <div class="profil__header--user-avatar" v-if="avatarUrl">
              ...
              <el-avatar :size="120" v-else :src="avatar.url"></el-avatar>
              <vui-single-upload
                class="button_upload"
          ...
          <section class="profil--about mt-3">
            <el-card class="box-card">
              <div slot="header" class="clearfix">
                <span>A propos</span>
                <el-button @click="openAbout = !openAbout" style="float: right; padding: 3px 0" class="text-dark" type="text" icon="el-icon-edit"></el-button>
              </div>
              <div class="text" v-if="!openAbout">
                <p v-if="profil && 'about' in profil && profil.about.length > 0" style="white-space: pre-line">{{ profil.about }}</p>
              ...
              <el-form  class="demo-ruleForm" v-else>
                ...
                <el-form-item>
                  <el-button type="success" size="small" :disabled="isChangedAbout" @click="onSubmitAbout">Modifier</el-button>
                </el-form-item>
              </el-form>
            </el-card>
          </section>
          ...
          <section class="profil--places-published mt-3">
            <el-card class="box-card">
              <div slot="header" class="clearfix">
                <span>Lieux publiés récemment</span>
                <el-button style="float: right; padding: 3px 0" type="text">Voir tous</el-button>
              </div>
              <nuxt-link :to="'/places/view/' + place.id " :underline="false" v-for="(place, i) in placeAll" :key="i" class="profil--places-published__content p-2">
                <div class="d-flex align-items-center">
                    ...
                    <div class="profil--places-published__content--title">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <vui-tag :label="category(place.category).label" :color="category(place.category).color" />
                        </div>
                    </div>
                </div>
                Mettre la protection de modification
            </nuxt-link>
            </el-card>
          </section>
        </b-container>
        ...
        <!-- Modal edition-->
      <el-dialog :visible="false"></el-dialog>
  ...
  export default {
    ...
    components: { VuiSingleUpload, VuiTag },
    ...
    computed: {
      ...mapGetters("app", { users: "getUsers", places: 'getPlaces', categories: 'getCategories', cities: 'getCities' }),
    ...
    methods: {
      ...
      changeFile(image, sectionEdit) {
        imageConversion
          ...
          .then((res) => {
            this[sectionEdit] = { file: res, url: URL.createObjectURL(res) };
            this.$bvModal
