    ...
    >
      ...
      <div class="d-flex align-items-center">
        <div class="d-none d-md-block">
          <ul class="d-flex">
            <b-nav-item>
              <NuxtLink exact class="d-block" to="/"
                ><i class="el-icon-house"></i> Accueil</NuxtLink
              >
            </b-nav-item>
            <b-nav-item>
              <NuxtLink class="d-block" to="/places"
                ><i class="el-icon-view"></i> Lieux</NuxtLink
              >
            </b-nav-item>
          </ul>
        </div>
        ...
        <el-dropdown trigger="click" class="d-md-none d-block">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>
              <NuxtLink class="d-block" exact to="/"
                ><i class="el-icon-house"></i> Accueil</NuxtLink
              >
            </el-dropdown-item>
            <el-dropdown-item>
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>
              <NuxtLink :to="{ name: 'login' }" class="d-block"
                ><i class="el-icon-s-unfold"></i> Connexion</NuxtLink
              >
            </el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>
              <NuxtLink class="d-block" to="/places/add"
                ><i class="el-icon-plus"></i> Ajouter un lieu</NuxtLink
              >
            </el-dropdown-item>
            <el-dropdown-item>
              <NuxtLink
                class="d-block"
                :to="'/profil/view/' + user.uid "
                ><i class="el-icon-user"></i> Profil</NuxtLink
              >
            </el-dropdown-item>
            <el-dropdown-item>
              <NuxtLink
                class="d-block"
                :to="'/carnet/' + user.uid "
                ><i class="el-icon-notebook-1"></i> Carnet de routes</NuxtLink
              >
            </el-dropdown-item>
            <el-dropdown-item>
              <a class="d-block" to="/" @click="handleLogOut"
                ><i class="el-icon-s-fold"></i> Déconnexion</a
              >
            </el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
